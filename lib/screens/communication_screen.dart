  ...
  void _loadMockData() {
    conversations = [
      ChatConversation(
        ...
        otherUserRole: 'rentador',
        lastMessageAt: DateTime.now().subtract(const Duration(minutes: 5)),
        lastMessage: '¿A qué hora puedo recoger el tractor?',
        unreadCount: 1,
        messages: [
          ChatMessage(
            id: 'M001',
            conversationId: 'C001',
            senderId: 'user_landlord',
            senderName: 'Arrendador',
            senderRole: 'arrendador',
            message: 'Buenos días. El tractor está disponible desde las 8 AM.',
          ...
          ChatMessage(
            ...
            senderRole: 'rentador',
            message: '¿A qué hora puedo recoger el tractor?',
      ...
      ChatConversation(
        ...
        messages: [
          ChatMessage(
            ...
            senderRole: 'rentador',
            message: 'Muchas gracias por el excelente servicio',
      ...
      ChatConversation(
        ...
        lastMessage: 'Listo para entregar el tractor',
        unreadCount: 0,
        messages: [],
      ),
    ];
    ...
    myReviews = [
      Review(
        ...
        reviewerRole: 'rentador',
        rating: 5.0,
        comment: 'Excelente tractor en perfecto estado. Muy recomendado.',
        createdAt: DateTime.now().subtract(const Duration(days: 5)),
        categories: ['equipment_condition', 'punctuality', 'communication'],
      ),
      Review(
        id: 'R002',
        rentalId: 'RENT002',
        ...
        reviewerRole: 'rentador',
        rating: 4.5,
        comment: 'Buena comunicación y equipo en buen estado.',
        createdAt: DateTime.now().subtract(const Duration(days: 10)),
        categories: ['equipment_condition', 'communication', 'price_value'],
      ),
      Review(
        id: 'R003',
        rentalId: 'RENT003',
        ...
        reviewerRole: 'rentador',
        rating: 4.0,
        comment: 'Buena experiencia, tractor funcionó bien.',
        createdAt: DateTime.now().subtract(const Duration(days: 15)),
        categories: ['equipment_condition', 'punctuality'],
      ),
    ];
    ...
    renterRatings = [
      RenterRating(
        id: 'RENTER001',
        renterName: 'Juan Pérez López',
        renterEmail: 'juan@example.com',
        averageRating: 4.8,
        totalReviews: 12,
        isVerified: true,
        reviews: [],
      ...
      RenterRating(
        id: 'RENTER003',
        renterName: 'Carlos López Martín',
